...
open class TransactionListCell: UITableViewCell {
  ...
  var cellController: TransactionListCellController?
  ...
  func set(mcc: MCC?, amount: Amount?, transactionDescription: String?, date: Date) {
    ...
    dateLabel.text = TransactionListCell.dateFormatter.string(from: date)
