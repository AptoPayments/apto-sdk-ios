//
//  ManageShiftCardViewControllerTheme1.swift
//  ShiftSDK
//
...
class ManageShiftCardViewControllerTheme1: ManageShiftCardViewControllerProtocol {
  ...
  init(mode: ShiftCardModuleMode, uiConfiguration: ShiftUIConfig, eventHandler: ManageShiftCardEventHandler) {
    ...
    self.mainView = ManageShiftCardMainViewTheme1(uiConfiguration: uiConfiguration, cardStyle: nil, delegate: self)
...
extension ManageShiftCardViewControllerTheme1: ManageShiftCardMainViewDelegate, ActivateCardViewDelegate {
  func cardTapped() {
    eventHandler.cardSettingsTapped()
  }
  ...
  @objc func activatePhysicalCardTapped() {
    eventHandler.activatePhysicalCardTapped()
  }
...
extension ManageShiftCardViewControllerTheme1: UITableViewDelegate {
...
private extension ManageShiftCardViewControllerTheme1 {
  ...
  func setUpTransactionList() {
    transactionsList.backgroundColor = uiConfiguration.uiBackgroundPrimaryColor
  ...
  func setUpActivateCardView() {
    ...
    activateCardView.backgroundColor = uiConfiguration.uiBackgroundPrimaryColor
...
private extension ManageShiftCardViewControllerTheme1 {
  func setupViewModelSubscriptions() {
    ...
    viewModel.orderedStatus.observeNext { [unowned self] orderedStatus in
