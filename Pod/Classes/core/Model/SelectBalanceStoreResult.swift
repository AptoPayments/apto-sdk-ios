...
private let balanceValidationsEmailSendsDisabled = 200_040
private let balanceValidationsInsufficientApplicationLimit = 200_041
private let identityNotVerified = 200_046
...
public struct SelectBalanceStoreResult: Equatable {
    ...
    public var errorMessage: String {
        guard isError, let errorCode = errorCode else {
            return ""
        }
...
public extension SelectBalanceStoreResult {
    var event: Event {
        guard isError, let errorCode = errorCode else {
