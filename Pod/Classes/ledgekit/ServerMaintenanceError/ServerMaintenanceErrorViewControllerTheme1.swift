//
//  ServerMaintenanceErrorViewControllerTheme1.swift
//  ShiftSDK
//
...
class ServerMaintenanceErrorViewControllerTheme1: UIViewController {
...
// MARK: - setup UI
private extension ServerMaintenanceErrorViewControllerTheme1 {
  ...
  private func setUpTitleLabel() {
    ...
    titleLabel.text = "maintenance.title".podLocalized()
